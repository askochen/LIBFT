...
ft_lstiter.c ft_lstmap.c ft_list_size.c ft_lstadd_end.c \
ft_lstinsert.c ft_strrev.c ft_swap_char.c#
...
ft_lstiter.o ft_lstmap.o  ft_list_size.o ft_lstadd_end.o \
ft_lstinsert.o ft_strrev.o ft_swap_char.o
FLAGS = -Wall -Wextra -Werror
all:$(NAME)
$(NAME):
	gcc -c $(FLAGS) $(SRC) libft.h
	ar rc $(NAME) $(OBJ)
	ranlib $(NAME)
clean:
	rm -f $(OBJ)
